...
export default function Setting(props: AllWidgetSettingProps<IMConfig>) {
  ...
  return (
    <div style={box}>
      ...
      <div style={hint}>Qui il RI compone le nuove voci interne usando le stesse categorie del prezzario regionale. Il prezzo della voce interna viene ricalcolato come somma delle righe di analisi.</div>
