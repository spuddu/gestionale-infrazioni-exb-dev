  ...
  return (
    <div style={box}>
      ...
      <div style={section}>
        ...
        <input style={inp} value={cfg.vociUrl || ''} onChange={(e) => set('vociUrl', e.target.value)} placeholder='https://services2.arcgis.com/.../FeatureServer/0' />

        <label style={lbl}>URL tabella analisi prezzario</label>
      ...
      <div style={hint}>Il widget importa il pacchetto CSV regionale compresso (.zip), normalizza articoli e analisi e li carica nelle tabelle AGOL già predisposte.</div>
      <div style={hint}><b>Importante:</b> caricare lo ZIP originale del prezzario regionale senza estrarlo. Non caricare i due CSV separatamente.</div>
