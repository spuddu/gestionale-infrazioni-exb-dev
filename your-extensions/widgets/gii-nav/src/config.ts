...
export const defaultConfig: Config = {
  ...
  items: [
    ...
    { id:'nav_nuova',     visible:true, order:3, label:'Nuova Pratica',  hashPage:'nuova',     colorBg:'#7c2d12', colorAccent:'#f97316', colorBgRest:'rgba(255,255,255,0.05)', colorBgHover:'#7c2d12ee', roles:['IT','ADMIN'],           icon:'nuova'     },
    ...
    { id:'nav_dashboard', visible:true, order:5, label:'Dashboard',      hashPage:'dashboard', colorBg:'#858519', colorAccent:'#fefe2a', colorBgRest:'rgba(255,255,255,0.05)', colorBgHover:'#858519ee', roles:['RIT','DT','DA','ADMIN'], icon:'dashboard' },
    { id:'nav_report',    visible:true, order:6, label:'Report',         hashPage:'report',    colorBg:'#4a1d96', colorAccent:'#b79ffe', colorBgRest:'rgba(255,255,255,0.05)', colorBgHover:'#4a1d96ee', roles:['RIT','DT','DA','ADMIN'], icon:'report'    },
  ]
}
