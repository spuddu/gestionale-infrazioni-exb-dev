  ...
  return (
    <div style={box}>
      ...
      <div style={section}>
        ...
        <label style={lbl}>Colore etichette campi parametro</label>
        <div style={colorRow}>
          <input style={colorInp} type='color' value={toolbarLabelColor} onChange={(e) => set('toolbarLabelColor', e.target.value)} aria-label='Colore etichette campi parametro' />
          <input style={inp} value={toolbarLabelColor} onChange={(e) => set('toolbarLabelColor', e.target.value)} placeholder='#1F4E79' />
        </div>

        <label style={lbl}>Dimensione etichette campi parametro (px)</label>
        ...
        <div style={hint}>Queste impostazioni si applicano alle etichette del modulo parametri.</div>
      </div>
      ...
      <div style={section}>
        ...
        <div style={hint}>Queste impostazioni sono predisposte per i titoli interni del widget e mantengono il pannello setting allineato agli altri widget prezzari.</div>
      </div>
      ...
      <div style={hint}>Il widget è riservato al RI o ad ADMIN e usa la sessione già gestita dal cw header.</div>
    </div>
  )
}
