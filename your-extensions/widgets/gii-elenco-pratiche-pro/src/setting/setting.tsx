...
const VIRTUAL_FIELDS: FieldOpt[] = [
  ...
  { name:'__accertamento_numero_display__', alias:'⚙ N. atto (calcolato)', type:'virtual' },
...
const FALLBACK_LAYER_FIELDS: FieldOpt[] = [
  ...
  { name:'accertamento_numero', alias:'Numero atto', type:'esriFieldTypeString' },
  { name:'accertamento_data', alias:'Data atto', type:'esriFieldTypeDate' },
