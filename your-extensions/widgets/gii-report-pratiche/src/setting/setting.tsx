...
const P = {
  ...
  sec: { fontSize: 11, fontWeight: 700, color: '#c4b5fd', textTransform: 'uppercase' as const, letterSpacing: 1.2, borderBottom: '1px solid rgba(255,255,255,0.10)', paddingBottom: 6, marginBottom: 14, marginTop: 22 } as React.CSSProperties,
...
export default function Setting (props: AllWidgetSettingProps<IMConfig>) {
  ...
  return (
    <div style={P.wrap}>
      ...
      <div style={P.hint}>Il report parte sempre dalle pratiche consultabili dall’utente collegato. Questa clausola serve solo per restringere ulteriormente i risultati.</div>
      <div style={P.row2}>
        <div>
        ...
        <div>
          <label style={P.lbl}>Righe per pagina</label>
          <NumInp value={Number(cfg.tableRows || 25)} min={5} step={5} onChange={v => update('tableRows', v)} />
        </div>
      </div>
